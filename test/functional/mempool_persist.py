...
By default, yiyad will dump mempool on shutdown and
...
class MempoolPersistTest(YiyaTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give yiyad a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent yiyad from writing mempool.dat to disk. Verify that `savemempool` fails")
