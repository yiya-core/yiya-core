...
class TxnMallTest(YiyaTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 YIYA:
        ...
        # First: use raw transaction API to send 1240 YIYA to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 YIYA coin each
        ...
        # Node0's balance should be starting balance, plus 50YIYA for another
        ...
        # Node0's total balance should be starting balance, plus 100YIYA for 
