...
from test_framework.test_framework import YiyaTestFramework, SkipTest
...
class ZMQTest (YiyaTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that yiya has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("yiyad has not been built with zmq enabled.")
