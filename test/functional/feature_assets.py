...
class AssetTest(YiyaTestFramework):
    ...
    def big_test(self):
        ...
        n0.listassets(asset="YIYA*", verbose=False, count=2, start=-2)
        ...
        yiya_assets = n0.listassets(asset="YIYA*", verbose=False, count=2, start=-2)
        assert_equal(len(yiya_assets), 2)
        assert_equal(yiya_assets[0], "YIYA2")
        assert_equal(yiya_assets[1], "YIYA3")
        self.sync_all()
