...
# TestNode: A peer we use to send messages to yiyad, and store responses.
...
class CompactBlocksTest(YiyaTestFramework):
    ...
    # This test actually causes yiyad to (reasonably!) disconnect us, so do this last.
    ...
    # Test that yiyad requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for yiyad to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # yiyad will not send blocktxn responses for blocks whose height is
