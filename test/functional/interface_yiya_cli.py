...
class TestYiyaCli(YiyaTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `yiya-cli getinfo`")
        ...
        self.log.info("Compare responses from `yiya-cli -getinfo` and the RPCs data is retrieved from.")
