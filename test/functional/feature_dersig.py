...
class BIP66Test(YiyaTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # yiyad is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and yiyad produces more specific reject
            # reasons.
