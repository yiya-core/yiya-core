...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the YiyaTestFramework
    pass

class ExampleTest(YiyaTestFramework):
    # Each functional test is a subclass of the YiyaTestFramework class.
    ...
    def custom_method(self):
        ...
        YiyaTestFramework class so other tests can use it."""
