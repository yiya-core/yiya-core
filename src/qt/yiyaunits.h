...
#ifndef YIYA_QT_YIYAUNITS_H
#define YIYA_QT_YIYAUNITS_H
...
/** Yiya unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class YiyaUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit YiyaUnits(QObject *parent);

    /** Yiya units.
      @note Source: https://en.yiya.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        YIYA,
...
typedef YiyaUnits::Unit YiyaUnit;

#endif // YIYA_QT_YIYAUNITS_H
