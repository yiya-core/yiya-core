...
#ifndef YIYA_QT_YIYAGUI_H
#define YIYA_QT_YIYAGUI_H
...
/**
  Yiya GUI main class. This class represents the main window of the Yiya UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class YiyaGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit YiyaGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~YiyaGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a yiya wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
