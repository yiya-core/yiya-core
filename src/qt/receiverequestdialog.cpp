...
#include "config/yiya-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatYiyaURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + YiyaUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatYiyaURI(info));
}
