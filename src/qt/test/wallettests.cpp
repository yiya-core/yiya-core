...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<YiyaAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_yiya-qt -platform xcb      # Linux
//     src/qt/test/test_yiya-qt -platform windows  # Windows
//     src/qt/test/test_yiya-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = YiyaUnits::formatWithUnit(unit, balance, false, YiyaUnits::separatorAlways);
    ...
    // Amount input
    YiyaAmountField* amountInput = receiveCoinsDialog.findChild<YiyaAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: yiya:")) != -1);
