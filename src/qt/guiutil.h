...
#ifndef YIYA_QT_GUIUTIL_H
#define YIYA_QT_GUIUTIL_H
...
/** Utility functions used by the Yiya Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "yiya:" URI into recipient object, return true on successful parsing
