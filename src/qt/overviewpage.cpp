...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(YiyaUnits::YIYA),
    ...
    assetdelegate(new AssetViewDelegate(platformStyle, this))
{
    ...
    ui->yiyaBalancesLabel->setStyleSheet(STRING_LABEL_COLOR);
    ...
    ui->yiyaBalancesLabel->setFont(GUIUtil::getTopLabelFont());
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(YiyaUnits::formatWithUnit(unit, balance, false, YiyaUnits::separatorAlways));
    ui->labelUnconfirmed->setText(YiyaUnits::formatWithUnit(unit, unconfirmedBalance, false, YiyaUnits::separatorAlways));
    ui->labelImmature->setText(YiyaUnits::formatWithUnit(unit, immatureBalance, false, YiyaUnits::separatorAlways));
    ui->labelTotal->setText(YiyaUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, YiyaUnits::separatorAlways));
    ui->labelWatchAvailable->setText(YiyaUnits::formatWithUnit(unit, watchOnlyBalance, false, YiyaUnits::separatorAlways));
    ui->labelWatchPending->setText(YiyaUnits::formatWithUnit(unit, watchUnconfBalance, false, YiyaUnits::separatorAlways));
    ui->labelWatchImmature->setText(YiyaUnits::formatWithUnit(unit, watchImmatureBalance, false, YiyaUnits::separatorAlways));
    ui->labelWatchTotal->setText(YiyaUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, YiyaUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("YIYA")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the YIYA balance grid from expanding and looking terrible when asset balance is hidden
