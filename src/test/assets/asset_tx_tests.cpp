...
BOOST_FIXTURE_TEST_SUITE(asset_tx_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(asset_tx_valid_test)
    {
        ...
        CAssetTransfer asset("YIYA", 1000);
    ...
    BOOST_AUTO_TEST_CASE(asset_tx_not_valid_test)
    {
        ...
        // This should fail because 900 YIYA doesn't have a destination
        CAssetTransfer assetTransfer("YIYA", 100);
    ...
    BOOST_AUTO_TEST_CASE(asset_tx_valid_multiple_outs_test)
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            CAssetTransfer asset2("YIYA", 100);
    ...
    BOOST_AUTO_TEST_CASE(asset_tx_multiple_assets_test)
    {
        ...
        CAssetTransfer asset2("YIYATEST", 1000);
        CScript scriptPubKey2 = GetScriptForDestination(DecodeDestination(Params().GlobalBurnAddress()));
        asset2.ConstructTransaction(scriptPubKey2);

        CAssetTransfer asset3("YIYATESTTEST", 1000);
        ...
        {
            // Add the first asset
            CAssetTransfer outAsset("YIYA", 100);
            ...
            CAssetTransfer outAsset2("YIYATEST", 100);
            ...
            // Add the third asset
            CAssetTransfer outAsset3("YIYATESTTEST", 100);
        ...
        // The inputs are spending 3000 Assets (1000 of each YIYA, YIYATEST, YIYATESTTEST)
        // The outputs are spending 100 Assets to 10 destinations (10 * 100 = 1000) (of each YIYA, YIYATEST, YIYATESTTEST)
