...
BOOST_FIXTURE_TEST_SUITE(netbase_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(netbase_splithost_test)
    {
        ...
        BOOST_CHECK(TestSplitHost("www.yiyacore.org", "www.yiyacore.org", -1));
        BOOST_CHECK(TestSplitHost("[www.yiyacore.org]", "www.yiyacore.org", -1));
        BOOST_CHECK(TestSplitHost("www.yiyacore.org:80", "www.yiyacore.org", 80));
        BOOST_CHECK(TestSplitHost("[www.yiyacore.org]:80", "www.yiyacore.org", 80));
        BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
        BOOST_CHECK(TestSplitHost("127.0.0.1:15792", "127.0.0.1", 15792));
        BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
        BOOST_CHECK(TestSplitHost("[127.0.0.1]:15792", "127.0.0.1", 15792));
        BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
        BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:15792", "::ffff:127.0.0.1", 15792));
        BOOST_CHECK(TestSplitHost("[::]:15792", "::", 15792));
        BOOST_CHECK(TestSplitHost("::15792", "::15792", -1));
        BOOST_CHECK(TestSplitHost(":15792", "", 15792));
        BOOST_CHECK(TestSplitHost("[]:15792", "", 15792));
    ...
    BOOST_AUTO_TEST_CASE(netbase_lookupnumeric_test)
    {
        ...
        BOOST_CHECK(TestParse("127.0.0.1:15792", "127.0.0.1:15792"));
        BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
        BOOST_CHECK(TestParse("::", "[::]:65535"));
        BOOST_CHECK(TestParse("[::]:15792", "[::]:15792"));
        BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
