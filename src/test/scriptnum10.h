...
#ifndef YIYA_TEST_SCRIPTNUM10_H
#define YIYA_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Yiya Core 0.10.0, for cross-comparison.
 */
public:
