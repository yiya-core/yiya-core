...
#ifndef YIYA_VALIDATION_H
#define YIYA_VALIDATION_H
...
/** Block download timeout base, expressed in millionths of the block interval (i.e. 10 min) */ // TODO Should we change this for yiya, with 1 minutes block intervals?
