...
This document provides guidelines for internationalization of the Yiya Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `yiya_en.ts` remains unchanged.
