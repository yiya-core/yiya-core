...
pkgdatadir = $(datadir)/yiya
pkgincludedir = $(includedir)/yiya
pkglibdir = $(libdir)/yiya
pkglibexecdir = $(libexecdir)/yiya
...
am__aclocal_m4_deps = $(top_srcdir)/build-aux/m4/ax_boost_base.m4 \
	...
	$(top_srcdir)/build-aux/m4/yiya_find_bdb48.m4 \
	$(top_srcdir)/build-aux/m4/yiya_qt.m4 \
	$(top_srcdir)/build-aux/m4/yiya_subdir_to_include.m4 \
...
CONFIG_HEADER = $(top_builddir)/src/config/yiya-config.h
CONFIG_CLEAN_FILES = libyiyaconsensus.pc share/setup.nsi \
...
CONFIG_CLEAN_VPATH_FILES = contrib/filter-lcov.py \
	test/functional/test_runner.py test/util/yiya-util-test.py \
...
ACLOCAL = ${SHELL} /home/fra/Scrivania/per_digi/from_pexa/yiya-core/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /home/fra/Scrivania/per_digi/from_pexa/yiya-core/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/fra/Scrivania/per_digi/from_pexa/yiya-core/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/fra/Scrivania/per_digi/from_pexa/yiya-core/build-aux/missing automake-1.15
AWK = gawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
...
COPYRIGHT_HOLDERS_FINAL = The Yiya Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = Yiya Core
COPYRIGHT_YEAR = 2019
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /home/fra/Scrivania/per_digi/from_pexa/yiya-core/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = yiya
PACKAGE_BUGREPORT = https://github.com/yiyacoin/core/issues
PACKAGE_NAME = Yiya Core
PACKAGE_STRING = Yiya Core 1.5.2
PACKAGE_TARNAME = yiya
PACKAGE_URL = https://yiyaproject.com/
...
YIYA_CLI_NAME = yiya-cli
YIYA_DAEMON_NAME = yiyad
YIYA_GUI_NAME = yiya-qt
YIYA_TX_NAME = yiya-tx
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/fra/Scrivania/per_digi/from_pexa/yiya-core
abs_srcdir = /home/fra/Scrivania/per_digi/from_pexa/yiya-core
abs_top_builddir = /home/fra/Scrivania/per_digi/from_pexa/yiya-core
abs_top_srcdir = /home/fra/Scrivania/per_digi/from_pexa/yiya-core
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/fra/Scrivania/per_digi/from_pexa/yiya-core/build-aux/install-sh
...
pkgconfig_DATA = libyiyaconsensus.pc
YIYAD_BIN = $(top_builddir)/src/$(YIYA_DAEMON_NAME)$(EXEEXT)
YIYA_QT_BIN = $(top_builddir)/src/qt/$(YIYA_GUI_NAME)$(EXEEXT)
YIYA_CLI_BIN = $(top_builddir)/src/$(YIYA_CLI_NAME)$(EXEEXT)
YIYA_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
YIYA_CLI_INSTALL = $(top_builddir)/contrib/install_cli.sh
empty := 
space := $(empty) $(empty)
OSX_APP = Yiya-Qt.app
...
OSX_INSTALLER_ICONS = $(top_srcdir)/src/qt/res/icons/yiya.icns
OSX_PLIST = $(top_builddir)/share/qt/Info.plist #not installed
OSX_QT_TRANSLATIONS = da,de,es,hu,ru,uk,zh_CN,zh_TW
DIST_DOCS = $(wildcard doc/*.md) $(wildcard doc/release-notes/*.md)
DIST_CONTRIB = $(top_srcdir)/contrib/yiya-cli.bash-completion \
	       $(top_srcdir)/contrib/yiya-tx.bash-completion \
	       $(top_srcdir)/contrib/yiyad.bash-completion \
...
WINDOWS_PACKAGING = $(top_srcdir)/share/pixmaps/yiya.ico \
...
COVERAGE_INFO = baseline.info \
  test_yiya_filtered.info total_coverage.info \
  baseline_filtered.info functional_test.info functional_test_filtered.info \
  test_yiya_coverage.info test_yiya.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/yiya.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/Yiya-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings \
  $(OSX_APP)/Contents/MacOS/yiyad $(OSX_APP)/Contents/MacOS/yiya-cli $(OSX_APP)/Contents/MacOS/install_cli.sh
...
EXTRA_DIST = $(DIST_SHARE) test/functional/test_runner.py \
	...
	test/util/yiya-util-test.py test/util/data/yiya-util-test.json \
...
CLEANFILES = $(OSX_DMG) $(YIYA_WIN_INSTALLER)
...
src/config/yiya-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/yiya-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/yiya-config.h
$(top_srcdir)/src/config/yiya-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/yiya-config.h src/config/stamp-h1
libyiyaconsensus.pc: $(top_builddir)/config.status $(srcdir)/libyiyaconsensus.pc.in
...
$(YIYA_WIN_INSTALLER): all-recursive
	$(MKDIR_P) $(top_builddir)/release
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(YIYAD_BIN) $(top_builddir)/release
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(YIYA_QT_BIN) $(top_builddir)/release
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(YIYA_CLI_BIN) $(top_builddir)/release
...
$(OSX_APP)/Contents/Resources/yiya.icns: $(OSX_INSTALLER_ICONS)
	$(MKDIR_P) $(@D)
	$(INSTALL_DATA) $< $@

$(OSX_APP)/Contents/MacOS/install_cli.sh: $(YIYA_CLI_INSTALL)
	$(MKDIR_P) $(@D)
	$(INSTALL_DATA) $< $@

$(OSX_APP)/Contents/MacOS/Yiya-Qt: $(YIYA_QT_BIN)
	$(MKDIR_P) $(@D)
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM)  $< $@

$(OSX_APP)/Contents/MacOS/yiyad: $(YIYAD_BIN)
	$(MKDIR_P) $(@D)
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM)  $< $@

$(OSX_APP)/Contents/MacOS/yiya-cli: $(YIYA_CLI_BIN)
	$(MKDIR_P) $(@D)
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM)  $< $@
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Yiya-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Yiya-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_yiya.info: baseline_filtered.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c $(LCOV_OPTS) -d $(abs_builddir)/src -t test_yiya -o $@
#	$(LCOV) -z $(LCOV_OPTS) -d $(abs_builddir)/src

#test_yiya_filtered.info: test_yiya.info
#	$(abs_builddir)/contrib/filter-lcov.py $(LCOV_FILTER_PATTERN) $< $@
#	$(LCOV) -a $@ $(LCOV_OPTS) -o $@

#functional_test.info: test_yiya_filtered.info
...
#test_yiya_coverage.info: baseline_filtered.info test_yiya_filtered.info
#	$(LCOV) -a $(LCOV_OPTS) baseline_filtered.info -a test_yiya_filtered.info -o $@

#total_coverage.info: test_yiya_filtered.info functional_test_filtered.info
#	$(LCOV) -a $(LCOV_OPTS) baseline_filtered.info -a test_yiya_filtered.info -a functional_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_yiya.coverage/.dirstamp:  test_yiya_coverage.info
...
#cov: test_yiya.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf coverage_percent.txt test_yiya.coverage/ total.coverage/ test/tmp/ cache/ $(OSX_APP)
