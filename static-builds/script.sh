...
find ${DISTNAME}/bin -type f -executable -exec ../yiyacoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../yiyacoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/yiyacoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/yiyacoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
